...
%>
        ...
        <tbody>
       <%
      ResultSet rs = st.executeQuery("select *from product inner join cart on product.id=product_id and cart.email='"+email+"' and cart.address is NULL");
      while(rs.next())
      {
...
<hr style="width: 100%">
<form action ="addressPaymentForAOrderAction.jsp" method ="post">
 <div class="left-div">
 <h3>Enter Address</h3>
...
<div class="right-div">
<h3>Pay online on this online.mr</h3>
